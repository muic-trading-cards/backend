...
def display_listing():
    ...
    card_images = {}
    #making a dictionary of card_id and card_image
    ...
    session.close()
    return render_template('listing.html', listings=listings, card_images=card_images, categories_dict=categories_dict)
